...
## What is programming? What is Java? (#a56a)
...
## Growth mindset and pair programming (#2b43)

# Unit: Values, variables, and expressions (2 weeks)

## Values and variables (#4b46)
...
## Building blocks of algorithms (#2ae6)
...
## Booleans and `if` statements (#29dc)
...
## Where do booleans come from? (#7e1f)
...
## Manipulating boolean expressions (#ad63)
...
## `if` statement traps and pitfalls (#f01e)
...
## Creating and using arrays (#34c9)
...
## Two-dimensional array algorithms (#8ecc)
...
## Implementing string algorithms (#1d3d)
...
## `ArrayList` and its methods (#0141)
...
## Recursive searching and sorting (#6931)
...
## Searching and sorting multiple-choice questions (#417a)

## Easier searching and sorting MCQs (#9d47)

## Medium searching and sorting MCQs (#79ce)

## Hard searching and sorting MCQs (#1070)
...
## Documentation and invariants (#0c19)
